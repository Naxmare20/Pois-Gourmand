...
<main>
  <article class="BlockMain">
    ...
    <img class="Image-command" src="../assets/img/nyork.jpg" alt="">
    <div class="Sous-BlockMain">
      <div class="Information-Formule">
        <h3 class="TitreFormule">Votre formule New-York Arrive dans quelques instants...</h3>
      ...
      <p class="Facture">-- Votre facture sera de 23 €</p>
