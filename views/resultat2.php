  ...
  <h1 class="Titre-Header">Au Pois Gourmand</h1>
   ...
   <main>
     <article class="BlockMain">
       ...
       <img class="Image-command" src="../assets/img/rome.jpg" alt="">
       <div class="Sous-BlockMain">
         <div class="Information-Formule">
           <h3 class="TitreFormule">Votre formule Rome Arrive dans quelques instants...</h3>
         ...
         <p class="Facture">-- Votre facture sera de 25 €</p>
