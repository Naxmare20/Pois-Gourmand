...
<main>
  <article class="BlockMain">
    ...
    <img class="Image-command" src="../assets/img/delhi.jpg" alt="">
    <div class="Sous-BlockMain">
      <div class="Information-Formule">
        <h3 class="TitreFormule">Votre formule Delhi Arrive dans quelques instants...</h3>
      ...
      <p class="Facture">-- Votre facture sera de 24 €</p>
